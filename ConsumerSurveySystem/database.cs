...
namespace ConsumerSurveySystem
{
    class database
    {
        private SQLiteConnection con = new SQLiteConnection("Data Source = css.db; Version=3; Compress=True;");
        ...
        public database()
        {
            ...
            string query = "Create Table userResponse(id int primary key,questionId int,  body varchar(255))";
